...
for c in ${cohorts[@]}; do
	...
	python3 /home/ec2-user/workspace/regtools/scripts/stats_wrapper.py default ${cohort}
        python3 /home/ec2-user/workspace/regtools/scripts/stats_wrapper.py i50e5 ${cohort}
        python3 /home/ec2-user/workspace/regtools/scripts/stats_wrapper.py E ${cohort}
        python3 /home/ec2-user/workspace/regtools/scripts/stats_wrapper.py I ${cohort}
